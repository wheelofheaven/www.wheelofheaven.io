...
ここでの接続点は、ヤハウェがラエルに明らかにしたことに基づく[Wheel of Heaven の仮説](../../essentials/elohim-hypothesis/)によれば、摩羯宮の時代の開始時に起こったことは、ジュラシックパークのページから直接取られたかのようなものであるということです。このシナリオでは、ビジョナリーな科学者のグループが遺伝子工学を通じて新しく、潜在的に危険な種を作り出し、それが最終的には災厄の結果をもたらし、彼らの研究を危険にさらす。
...
前章で指摘したように、[仮説](../../essentials/elohim-hypothesis/)で、我々は、ラエリアン教の三冊の創設書が示す物語を、正典として認識しています[^2]。これらの本は、神々と誤解されてきた永遠の者たちの評議会の首代表である[ヤハウェ](../../wiki/yahweh/)と、フランス人との一連の出会いを記録したものです。この評議会の永遠の者たちは、我々が一般的に[エロヒム](../../wiki/elohim/)と記憶している宇宙文明の政府機関として最も適しています。このフランス人は、地球の大使としての役割を指すラエルという名前を与えられ、新たな宗教運動である[ラエリアン教](../../wiki/raelism/)[^3]を形成しました。新設された運動の主な目標の一つは、ヤハウェによって委託されたメッセージを保管、翻訳し、受け入れる耳に伝えることです。これらのメッセージの中で、ヤハウェは神の概念を神秘化し、宗教の意味を改訂し、聖書の創世記の創造物語を詳細に再話します。
...
ラエルとヤハウェとの出会いで記録された物語の大部分は、聖書の解釈についての解説です。ヤハウェはエクゼゲティカルな方法[^5]で、創世記[^6]の間に何が起こったのかを思い起こします。しかし、彼が聖書の節を解説し始める前に、彼は[創世記](../../wiki/genesis/)で説明された出来事の序章を設けます。その序章は、私たちをジュラシックパークに戻します。

エロヒムの物語は明らかに地球から始まるものではありません。彼らは別の星、[エロヒムの母星](../../wiki/elohimian-home-planet/)から来たのです。ヤハウェは、創世記の出来事に先立って何があったのか、そしてそれらがどのようにして創世記の出来事につながったのかを思い出し始めます：
...
ジュラシックパークの伝説との類似性は驚くべきものです。約24,000年前、遥かなる星、エロヒムの母星で、その住民たちは、[人工的な遺伝子合成デノヴォ](../../wiki/synthetic-biology.md#artifical-gene-synthesis/)[^7]が可能な文明を発展させることに成功しました。これらの遺伝子工学の進歩は、新たな生命形態を合成的に設計するように彼らを導きました。最終的には、合成生命工学という研究の分野は、これらの合成的に創造された動物が逃げ出し、多くの人々を殺すという運命的な事故に終わりました。
...
[^6]: ヘブライ語のトーラーでの聖書の創世記はベレーシート（<span class="hebrew">בְּרֵאשִׁית</span>）と呼ばれ、文字通りにはヘブライ語で「初めに」という意味になります。これは、ヘブライ語の聖書では、書籍は冒頭語で名付けられているからです。ヘブライ聖書の最初の書籍の最初の言葉はベレーシート（"初めに..."）。詳細は[冒頭語](https://en.wikipedia.org/wiki/Incipit)を参照してください。
...
すでに指摘したように、その開発段階におけるエロヒム文明は、リソースとエネルギーの不足に基づく経済システムによって支配されていたと考えるのが合理的です。そこでは、信用システムが設けられ、最も適任の者に生産手段が配分されていたと思われます。また、遺伝子工学の実験研究を停止することになった公共の意見は、立法的であり、おそらく行政的な権力をもその側に傾けるほどの影響力を示していたと知られています。_Rēs pūblica_、つまり人々の事柄が考慮される共和制の要素を持つ政治システムも存在したと推測されます。

これら2つの仮定から、21世紀の私たち自身の経済的および政治的条件を大いに反映していますが、合成エンジニアリングの研究開発を担当していた研究者たちは、準企業的な社会機関（企業と呼んでもいいかもしれませんし、呼ばないかもしれません）のために働いていたと推測することができます。その機関は、その科学的洞察に伴う明るい頭脳と力を持っている可能性が高いでしょう。

そのような有望な研究がどのような経済的副作用を生み出したかを想像するだけでも驚きです。遺伝子コードをリバースエンジニアリングする能力は、ソフトウェアのソースコードを書くように新しい遺伝子コードを書くことができるほどまでに伸びています。化学的なソース成分だけで遺伝子コードをコンパイルし、統合する能力は、現在のようにソースコードを機械語に変換するのと同じです。解読された遺伝子のセットを用いて新しい特性を完全に理解し、模倣することは、現在のテクウィザードがソースコードを読み、新しい機能のセットで機能のリポジトリを拡張する方法を考案するのと似ています。これらのテクウィザードは、ソフトウェアエンジニアやソフトウェアアーキテクトとしてよく知られており、技術の限界を押し広げることで名を馳せており、それなりの生計を立てています。

この原則をデジタル計算装置で動作する機械語だけでなく、生物学的生命という機械にまで拡張すると、そこから推定できる可能性は目まぐるしいものとなります。あらゆる種類の製薬製品、あらゆる種類の疾患と生命短縮の苦難の治癒、寿命の延長、さらには死を超えた生命の保全が可能になるでしょう。エロヒム文明は、そのような技術の開発によって、自分たちだけの黄金時代に真に突入したと言えるでしょう。

その製品を消費し、それを購入する能力があるすべての人々の生活状況を改善するために責任を負っていた企業連合、知識と力の融合は、少なくとも注目に値すると言えるでしょう。遺伝子工学の進歩を可能にした者たちの遺産が、自由になった合成モンスターの創造につながったこと、その結果として大混乱が起きたことは、それ以上に注目に値し、その時代では高度に議論の的であった可能性があります。

それにもかかわらず、遺伝子工学の利益から生じた力の富は、エロヒム文明が宇宙探索の原因に資金と資源をどのように供給し、配分したかに直接影響を与えたと考えられます。これらの原因に共通する親和性は、同様のエージェント、つまり個人がこれらの原因の両方に貢献したという考えを強く支持しています。

{{< figure src="images/futuristic-city-with-tower.png" caption="図 3 - 先進的な都市景観" >}}

## 永遠の存在

ラエリアニズムの3つの基礎となる作品のうちの最初の1冊、[真実を告げる書](../../library/the-book-which-tells-the-truth/)<sup>📖</sup>の終わりに、ヤハウェは自分が誰であり、何が彼をエロヒムの主要な代表者たらしめるのかを明らかにします：

> 最も古い、永遠の存在の評議会の議長は、25,000歳で、あなたの前にいるのが彼です。私はこれまでに25体の体を生きてきました、そして私はこの実験が成功裏に行われた最初の人間でした。それが私が永遠の存在の議長である理由です。私自身が地球上での生命の創造を指導しました。

そこにあります。ヤハウェは科学的進歩の果実を最初に享受した人でした。エロヒム文明は、科学的手段を通じて複数の体を持つことを可能にする技術を開発し、完全にした。したがって、この技術を彼らに適用したいと願う個体を事実上不死にすることができました。25,000年という蓄積された年齢を考えると、不死の技術の発明をモズの時代の前、つまり地球に到着する前に時期を定めることができます。

## 一部の要約

山羊座の時代は12の世界時代の1つで、紀元前21,810年に始まり、各世界時代と同様に2,160年間続きました。その時間の前に、エロヒムという地球外文明が地球に到着しました。彼らの遺伝子実験の一つが脱走してしまったという悲劇的な事件が発生し、それによってエロヒムの命が失われ、その分野の研究が彼らの故郷の惑星で停止してしまったことに動機付けられ、エロヒムは新たな星間のフロンティアを探し求めました。惑星間、星間探検を追求していた研究者たちは、最終的に地球、外惑星を遺伝子研究のフロンティアとして選びました。

地球での新たな外惑星フロンティアの設立は、世界時代の進行の歳差運動の時計仕掛けを動かします。エロヒムが地球に到着したことで、山羊座の時代の始まり（紀元前21,810年から紀元前19,650年）が始まりました。この時代は、遺伝子の実験が地球上で開始され、さまざまな種類の生物が繁栄し、多様化した初期の期間と考えることができます。その後の水瓶座の時代には、先進的な遺伝子工学が行われ、結果的に人間が生み出されました。