...
description = "Сакральная геометрия , предположение о том, что геометрические понятия более высокого порядка использовались в ряде исторических структур, зданий и артефактов, предполагая, что их строители намеренно добавили дополнительное измерение смысла в свою работу, эффективно систематизировав свое наследие с помощью значимых пропорций и, следовательно, оставив отпечатки пальцев, намекающие на общую традицию знаний и мудрости."
+++
