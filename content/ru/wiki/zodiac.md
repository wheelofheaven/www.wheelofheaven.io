+++
title = "Зодиак"
description = "Зодиак — это полоса на небе, через которую проходит солнце, известная как эклиптика. В этой полосе можно найти 12 звездных созвездий, каждое из которых названо в честь животного. Таким образом, Зодиак предоставляет зоологические символы для правильного обозначения положения солнца на небе. С годами относительное положение Зодиака смещается на восток вдоль эклиптики из-за явления прецессии. При таком понимании зодиак можно рассматривать как основу для наименования 12 домов в продолжительном цикле, каждый из которых обозначает данную мировую эпоху."
+++
